...
public:
    ...
    void update(Tilemap *map, float time, float deltaTime, float cameraX, float cameraY) override;
    virtual Direction control(Tilemap *map, float time, float deltaTime, float cameraX, float cameraY) = 0;
