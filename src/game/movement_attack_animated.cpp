...
void MovementAttackAnimated::update(Tilemap *map, float time, float deltaTime, float cameraX, float cameraY) {
    Direction newDirection = control(map, time, deltaTime, cameraX, cameraY);
